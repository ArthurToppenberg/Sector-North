...
Danish coastline with city markers — scroll to zoom (anchored under the cursor), and pan
by click-dragging or with WASD / arrow keys.
...
│     ├─ src/data/         # Bundled map data (Denmark boundary, cities)
